            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>1</td>
                            <td class="text-center">{{ substr($basicSettings->about_description,'0','40') }}</td>
                            <td class="text-center">{{ substr($basicSettings->about_description,'0','100') }}</td>
                            <td>
                            <a class="btn btn-info" href="{{ route('about-edit',$basicSettings->about_id) }}">Edit</a>
                            </td>
                        </tr>
