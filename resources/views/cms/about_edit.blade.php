...
<div class="content">
   ...
   <div class="card">
      <div class="card-body">
      {!! Form::model($basicSettings, ['method' => 'PUT','route' => ['about-update', $basicSettings->about_id]]) !!}
         <fieldset class="mb-3">
            ...
            <div class="form-group row">
               ...
               <div class="col-lg-9">
               {!! Form::text('about_title', null, array('placeholder' => 'Name','class' => 'form-control')) !!}
               </div>
            </div> 
            ...
            <div class="form-group row">
               ...
               <div class="col-lg-9">
                  ...
                  {!! Form::textarea('about_description',null,['class'=>'form-control', 'rows' => 12, 'cols' => 40]) !!}
               </div>
            </div>
         </fieldset>
