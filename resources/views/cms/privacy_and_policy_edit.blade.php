...
<div class="content">
   ...
   <div class="card">
      <div class="card-body">
      {!! Form::model($basicSettings, ['method' => 'PUT','route' => ['policy-update', $basicSettings->privacy_policy_id]]) !!}
         <fieldset class="mb-3">
            ...
            <div class="form-group row">
               ...
               <div class="col-lg-9">
                  ...
                  {!! Form::textarea('privacy_policy',null,['class'=>'form-control', 'rows' => 12, 'cols' => 40]) !!}
               </div>
            </div>
         </fieldset>
